# Grade 1. Этап 2: Задание 3 Проверка дедлайна
...
while True:
    try:
        ...
        issue_date = input("Введите дату дедлайна (например ДД-ММ-ГГГГ или ГГГГ-ММ-ДД) или пустую строку для остановки программы: ")
        print(issue_date)
        ...
        print("Пример: 31-01-2025 или 2025-01-31")
